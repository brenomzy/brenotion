...
```bash
: "${CLERK_SECRET_KEY:?Set CLERK_SECRET_KEY before running this command}"
...
Set `CLERK_SECRET_KEY` to your Clerk Secret Key (`sk_test_...` or `sk_live_...`) and replace `YOUR_EXTENSION_ID` with your stable CRX ID.
